      ...
      <div className="max-w-3xl mx-auto">
        ...
        <header className="mb-12">
          ...
          <p className="text-text-s text-sm mt-1">
            ...
            <a href="tel:3473177613" className="text-accent hover:text-electric underline">347.317.7613</a>
          </p>
        </header>
        ...
        <div className="border-t border-[#0099ff]/12 pt-10">
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  {[
                    ...
                    <tr key={n} className="border-b border-[#0099ff]/6 align-top">
          ...
          <S title="6. Riferimenti normativi">
            ...
            <p>Per informazioni sul trattamento dei dati personali consulta la <Link to="/privacy" className="text-accent hover:text-electric underline">Privacy Policy</Link>.</p>
          </S>
        </div>
      </div>
    </div>
