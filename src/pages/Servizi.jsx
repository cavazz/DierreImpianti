...
export default function Servizi() {
  usePageMeta({
    ...
    description: 'Impianti elettrici civili industriali e speciali, fotovoltaico, domotica, antenne, reti dati, automazioni e videosorveglianza. Servizi professionali nella provincia di Padova.',
  })
  return (
    <>
      <PageBanner
